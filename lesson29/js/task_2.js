...
// модальное окно не отображается. При клике на кнопку "Открыть"
...
$modal = function (options) {
  ...
  function _createModal(options) {
    let elemModal = document.createElement("div"),
      modalTemplate =
        '<div class="modal__backdrop" data-dismiss="modal"><div class="modal__content"><div class="modal__header"><div class="modal__title" data-modal="title">{{title}}</div><span class="modal__btn-close" data-dismiss="modal" title="Close">×</span></div><div class="modal__body" data-modal="content">{{content}}</div>{{footer}}</div></div>',
